...
\begin{figure}[htb]
\centering
\subfloat[分立式CPU和GPU]{\includegraphics[width=.8\textwidth]{/Figs_background/discrete}} \qquad
\subfloat[集成式CPU和GPU]{\includegraphics[width=.8\textwidth]{/Figs_background/integrated}} 
