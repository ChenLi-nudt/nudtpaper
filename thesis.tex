...
\confidentiality{公开}
\UDC{}
\title{面向堆叠异构系统的架构与策略优化}
\displaytitle{面向堆叠异构系统的架构与策略优化}
\author{李晨}
\zhdate{\zhtoday}
\entitle{Research on the Key Techniques of Architecture and Strategy for Stacked Heterogeneous System}
\enauthor{Li Chen}
\endate{\entoday}
\subject{电子科学与技术}
\ensubject{Electronic Science and Technology}
\researchfield{计算机体系结构}
