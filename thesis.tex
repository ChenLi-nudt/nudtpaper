...
%
\documentclass[doctor,twoside,anon,otf]{nudtpaper}
\usepackage{mynudt}
\usepackage{listings} 
...
\confidentiality{公开}
\UDC{}
\title{面向堆叠异构系统的应用透明策略研究}
\displaytitle{面向堆叠异构系统的应用透明策略研究}
\author{李晨}
\zhdate{\zhtoday}
\entitle{Research on Application-transparent Strategies for Stacked Heterogeneous System}
\enauthor{Li Chen}
\endate{\entoday}
\subject{电子科学与技术}
\ensubject{Electronic Science and Technology}
\researchfield{微处理器体系结构}
